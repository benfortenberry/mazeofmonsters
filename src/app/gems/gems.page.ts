...
@Component({
    ...
    styleUrls: ['./gems.page.scss']
})
export class GemPage implements OnInit {
    tiles = [
        { id: 0, flipped: false, img: 'url(../../assets/gems/aqua.png)', show: true },
        { id: 1, flipped: false, img: 'url(../../assets/gems/aqua.png)', show: true },
        { id: 2, flipped: false, img: 'url(../../assets/gems/red.png)', show: true },
        { id: 3, flipped: false, img: 'url(../../assets/gems/red.png)', show: true },
        { id: 4, flipped: false, img: 'url(../../assets/gems/blue.png)', show: true },
        { id: 5, flipped: false, img: 'url(../../assets/gems/blue.png)', show: true },
        { id: 6, flipped: false, img: 'url(../../assets/gems/violet.png)', show: true },
        { id: 7, flipped: false, img: 'url(../../assets/gems/violet.png)', show: true },
        { id: 8, flipped: false, img: 'url(../../assets/gems/yellow.png)', show: true },
        { id: 9, flipped: false, img: 'url(../../assets/gems/yellow.png)', show: true },
        { id: 10, flipped: false, img: 'url(../../assets/gems/green.png)', show: true },
        { id: 11, flipped: false, img: 'url(../../assets/gems/green.png)', show: true }
    ];
